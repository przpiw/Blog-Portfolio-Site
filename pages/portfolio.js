        ...
        <main className='flex flex-row justify-center h-full mb-18'>
          ...
          <section className='h-full md:w-3/6 w-3/4 pb-96'>
            ...
            <div className='flex flex-row justify-around gap-8 flex-wrap'>
              <div className='group relative border-2 hover:border-blue-500'>
                <Image
                  loader={imgLoader}
                ...
                <div className=' absolute text-center bottom-0 left-0 right-0 opacity-80  transition h-1/3 duration-200 group-hover:bg-gray-400 '>
                  ...
                  <div className=' relative flex-row justify-around flex-wrap hidden group-hover:flex'>
                    ...
                    <div className='font-bold  px-1'>
                      <span className='before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-green-800 relative inline-block'>
                        <span className='relative text-white'>Node</span>
                      </span>
                    </div>
                    <div className='font-bold  px-1'>
                      <span className='before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-pink-500 relative inline-block'>
                        <span className='relative text-white'>Mongo</span>
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className='group relative border-2 hover:border-blue-500'>
                <Image
                  loader={imgLoader}
                  src='https://i.imgur.com/VHCdwNi.png'
                  alt="portfolio-item"
                  width={350}
                  height={250}
                  className='grayscale transition duration-400 group-hover:grayscale-0'
                ...
                <div className='absolute top-0 right-0 pt-1 ml-2 bg-gray-900 opacity-70 w-20 h-9 '>
                  <div className='flex flex-row  ml-2 mt-1 w-8 '>
                    <a
                      href='https://github.com/przpiw/Blog-Portfolio-Site/'
                      target='github'
                      rel='noopener noreferrer nofollow'
                      className='hover:text-gray-800  transition-colors mr-3 '
                    >
