const Socials = () => {
  return (
    <div className='flex flex-row text-2xl my-6 text-gray-400'>
      <a
        href='https://dev.to/przpiw'
        target='devto'
        rel='noopener noreferrer nofollow'
        className='hover:text-gray-800  transition-colors mr-3'
      >
        <svg
          aria-label='My Devto Page'
          stroke='currentColor'
          fill='currentColor'
          strokeWidth='0'
          viewBox='0 0 448 512'
      ...
      <a
        href='https://linkedin.com/in/damianpiwowarczyk'
        target='linkedin'
        rel='noopener noreferrer nofollow'
